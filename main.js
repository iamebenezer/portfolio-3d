...
let projects = [
  {
    image: 'textures/marscat.png',

  },
  {
    image: 'textures/based.png',
   
  },
  {
    image: 'textures/tax.png',
  
  },
  {
    image: 'textures/smurf.png',
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('CODING PAW', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / Graphic Desginer/ Video Editor / Content Creator',
      {
        font: font,
        size: 0.018,
        height: 0,
